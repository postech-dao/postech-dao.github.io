    ...
    members: [
      {
        ...
        socials: [
          ...
          { platform: 'linkedin', href: 'https://www.linkedin.com/in/junha-y-5923061b6/', label: 'LinkedIn' }
        ],
        bio: [
    ...
    members: [
      {
        ...
        socials: [
          ...
          { platform: 'linkedin', href: 'https://www.linkedin.com/in/basten1209/', label: 'LinkedIn' }
        ],
        bio: [
    ...
    members: [
      {
        ...
        socials: [
          ...
          { platform: 'linkedin', href: 'https://www.linkedin.com/in/taehoon-kim-393796185/', label: 'LinkedIn' },
      ...
      },
      {
        ...
        socials: [
          { platform: 'linkedin', href: 'https://www.linkedin.com/in/juyoung-jeong/', label: 'LinkedIn' },
