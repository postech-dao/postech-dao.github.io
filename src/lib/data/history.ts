...
export const historyYears: TimelineYear[] = [
  ...
  },
  {
    ...
    events: [
      ...
      { month: '11월', title: 'Qwen Base SKYST Hackathon 1st Prize (dydmr, blending-tea)' },
      { month: '11월', title: 'Qwen Base SKYST Hackathon TOP 10 (sigridjin, crab)' },
      { month: '10월', title: '"Blockchains for TradFi" 밋업 개최' },
      { month: '9월', title: 'Sui-mming Hackathon Seoul special prize (sigridjin)' },
      { month: '9월', title: 'Sui-mming Hackathon Seoul DSRV Prize (atmosis, hyeongsoo)' },
